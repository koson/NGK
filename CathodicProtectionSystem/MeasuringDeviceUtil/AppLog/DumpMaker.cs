...
namespace AppLog.AppDump
{
    ...
    //==========================================================================================================
    /// <summary>
    /// Каласс для создания дампа приложения при его крушениии (генерации необработанного исключения)
    ...
    public class DumpMaker
    {
        //------------------------------------------------------------------------------------------------------
        /// <summary>
        /// Путь к директории для сохранения дампа приложения
        /// </summary>
        private static String _PathToDirectory = String.Empty;
        //------------------------------------------------------------------------------------------------------
        /// <summary>
        /// Путь к директории для сохранения дампа приложения
        /// </summary>
        ...
        {
            get { return DumpMaker._PathToDirectory; }
            set { DumpMaker._PathToDirectory = value; }
        }
        //------------------------------------------------------------------------------------------------------
        /// <summary>
        /// Тип дампа приложения
        /// </summary>
        private static DUMP_TYPE _TypeOfDump = DUMP_TYPE.MiniDumpNormal;
        //------------------------------------------------------------------------------------------------------
        /// <summary>
        /// Тип дампа приложения
        /// </summary>
        public static DUMP_TYPE TypeOfDump
        {
            get { return DumpMaker._TypeOfDump; }
            set { DumpMaker._TypeOfDump = value; }
        }
        //------------------------------------------------------------------------------------------------------
        /// <summary>
        ...
        //------------------------------------------------------------------------------------------------------
        /// <summary>
        /// Метод для обработки небоработанног исключения приложения
        /// </summary>
        ...
        {
            String name;
            CreateMiniDump(DumpMaker._PathToDirectory, DumpMaker._TypeOfDump, out name);
        }
        //------------------------------------------------------------------------------------------------------
        /// <summary>
