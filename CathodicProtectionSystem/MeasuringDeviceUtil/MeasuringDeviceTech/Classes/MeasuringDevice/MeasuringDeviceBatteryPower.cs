...
{
    /// <summary>
    /// Класс реализует устройство БИ (блок измерений) на батарейном 
    /// (автономном) питании БИ(У)-01 код 9811.
    /// </summary>
    [Serializable]
    public class MeasuringDeviceBatteryPower : System.ComponentModel.INotifyPropertyChanged, IMeasuringDevice,
        System.Runtime.Serialization.IDeserializationCallback
    {
        ...
        {
            get { return TYPE_NGK_DEVICE.BI_BATTERY_POWER; }
        }
        ...
        /// <summary>
        /// Глубина коррозии датчика ИКП с устройства УС ИКП СТ
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Cкорость коррозии датчика ИКП с устройства УС ИКП СТ
        /// </summary>
        /// <remarks>
        ...
        [Browsable(true)]
        [ReadOnly(true)]
        [Category("Измеряемые параметры: Температуры")]
        [Description("Температура встроенного датчика, гр.С Только для НГК-БИ(У)-01")]
        [DisplayName("1. Температура встроенного датчика, гр.С")]
        [RefreshProperties(System.ComponentModel.RefreshProperties.All)]
        ...
        [RefreshProperties(System.ComponentModel.RefreshProperties.All)]
        public float LeakageСonstantСurrent
        {
            ...
            set
            {
                ...
                // Генерируем событие
                OnPropertyChanged(new PropertyChangedEventArgs("ReferenceElectrodeDcСurrent"));
            }
        }
        //------------------------------------------------------------------------------------------------------
        /// <summary>
        ...
        public UInt32 PollingPeriodUSIKPST
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException("Введённое не допустимое значение 0",
                        "PollingPeriodUSIKPST");
                }
            }
        }
        ...
        public override string  ToString()
        {
            ...
            sb.Append(Environment.NewLine);
            sb.Append(String.Format("Период опроса УС ИКП СТ, с: {0}", this.PollingPeriodUSIKPST.ToString()));
            sb.Append(Environment.NewLine);
            ...
            sb.Append(Environment.NewLine);
            sb.Append(String.Format("Температура строенного датчика, гр.С: {0}", this.InternalTemperatureSensor.ToString()));
            sb.Append(Environment.NewLine);
        ...
        public static Boolean Serialize(String path, MeasuringDeviceBatteryPower device)
        {
        ...
        /// <returns>Результат выполнения операции, 
        /// если false - не удалость сериализовать</returns>
        public static Boolean Serialize(FileStream stream, MeasuringDeviceBatteryPower device)
        {
            BinaryFormatter bf = new BinaryFormatter();
            Boolean result;
            if (stream != null)
        ...
        public static MeasuringDeviceBatteryPower Deserialize(String path)
        {
            ...
            {
                BinaryFormatter bf = new BinaryFormatter();
                device = (MeasuringDeviceBatteryPower)bf.Deserialize(fs);
            }
            catch
            {
                device = null;
        ...
        public static MeasuringDeviceBatteryPower Deserialize(FileStream stream)
        {
            MeasuringDeviceBatteryPower device;
            try
            {
                BinaryFormatter bf = new BinaryFormatter();
                device = (MeasuringDeviceBatteryPower)bf.Deserialize(stream);
            }
            catch (Exception e)
            {
                ...
                default:
                    {
                        ...
                        String msg = String.Format(
                            "Ошибка выполения чтения устройства. Устройство венуло ошибку: {0}",
                            result.Description);
            ...
            out OperationResult error)
        {
            ...
            value = new ushort[3];
            value[2] = (UInt16)serialNumber;
            value[1] = (UInt16)(serialNumber >> 16);
            value[1] = (UInt16)(serialNumber >> 32);
            ...
            out OperationResult error)
        {
            ...
            if (result.Error != Modbus.OSIModel.ApplicationLayer.Error.NoError)
            {
                error = new OperationResult(OPERATION_RESULT.OK, result.Description);
            }
            else
            {
            ...
            out OperationResult error)
        {
            ...
            unchecked
            {
                ...
                registers[1] = (UInt16)(totalSeconds); // Lo_byte
            }
            ...
            out OperationResult error, out DateTime dataTime)
        {
            ...
            if (result.Error == Modbus.OSIModel.ApplicationLayer.Error.NoError)
            {
                ...
                else
                {
                    ...
                    totalSeconds |= registers[1]; // Lo_byt
        ...
        {
            return MeasuringDeviceBatteryPower.Deserialize(path);
        }
        //------------------------------------------------------------------------------------------------------
        object IMeasuringDevice.Deserialize(FileStream stream)
        {
            return MeasuringDeviceBatteryPower.Deserialize(stream);
        }
        //------------------------------------------------------------------------------------------------------
        ...
        {
            return MeasuringDeviceBatteryPower.Serialize(path, this);
        }
        //------------------------------------------------------------------------------------------------------
        public Boolean Serialize(FileStream stream)
        {
            return MeasuringDeviceBatteryPower.Serialize(stream, this);
        }
        //------------------------------------------------------------------------------------------------------
