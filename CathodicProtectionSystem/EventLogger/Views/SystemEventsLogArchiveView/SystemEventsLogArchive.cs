...
{
    public partial class SystemEventsLogArchive : UserControl
    {
        #region Constructors

        public SystemEventsLogArchive()
        {
            InitializeComponent();
            Dock = DockStyle.Fill;
        ...
        {
            set { _LabelPageNumber.Text = value.ToString(); }
        }

        public int TotalPages
        {
            set { _LabelTotalPages.Text = value.ToString(); }
        }
