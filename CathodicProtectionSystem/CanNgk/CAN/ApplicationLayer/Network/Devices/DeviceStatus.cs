...
namespace NGK.CAN.ApplicationLayer.Network.Devices
{
    ...
    public enum DeviceStatus: byte
    {
        ...
        /// </summary>
        [Description("Ошибка соединения")] // Необходим для EnumTypeConverter
        ...
        /// </summary>
        [Description("Устройство остановлено")]
        Stopped = 4,
        //--------------------------------------------------------------------------------
        /// <summary>
        /// Устройство готово к работе
        /// </summary>
        [Description("Устройство готово")]
        Preoperational = 5,
        //--------------------------------------------------------------------------------
        /// <summary>
        /// Устройство работает в нормальном режиме
        /// </summary>
        [Description("Устройство работает")]
        Operational = 0x7F
        //--------------------------------------------------------------------------------
    }
    //====================================================================================
