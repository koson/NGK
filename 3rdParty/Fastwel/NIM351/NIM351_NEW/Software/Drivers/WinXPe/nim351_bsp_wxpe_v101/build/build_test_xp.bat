...
if not exist "..\configs\xp\test" echo Windows XP build configurations folder not found! & goto all_done
if not exist "..\src" echo Sources folder "..\src" not found! & goto all_done  

pushd xp
for /R "..\..\configs\xp\test" %%A in ("*.cfg") do (call vc_build_test %%~nA "..\..\src")
popd
