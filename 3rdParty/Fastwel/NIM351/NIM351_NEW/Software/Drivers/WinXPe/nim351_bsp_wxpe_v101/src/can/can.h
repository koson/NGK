 ...
 *  Скорости обмена
 */
typedef u32 F_CAN_BAUDRATE;

// Константы для задания частот из набора рекомендованного CiA
#define CANBR_1MBaud      0   // 1 MBit/sec
#define CANBR_800kBaud    1   // 800 kBit/sec
#define CANBR_500kBaud    2   // 500 kBit/sec
#define CANBR_250kBaud    3   // 250 kBit/sec
#define CANBR_125kBaud    4   // 125 kBit/sec
#define CANBR_100kBaud    5   // 100 kBit/sec
#define CANBR_50kBaud     6   // 50 kBit/sec
#define CANBR_20kBaud     7   // 20 kBit/sec
#define CANBR_10kBaud     8   // 10 kBit/sec

// Макрос для задания частот, непосредственно в регистрах контроллера.
// Используется для задания нестандартных частот.
#define CANBR_Btr0Btr1(btr0, btr1)  ((((u32)((btr0)&0xFF))<<24) | (((u32)((btr1)&0xFF))<<16))
// btr0, btr1 - соответствуют значениям регистров BTR0 и BTR1 CAN контроллера Philips SJA 1000
// с задающей частотой 16 Мгц. Более подробная информация по конфигурированию частоты передачи
// контроллера приведена в разделе 6.5 спецификации Philips SJA 1000.

// Макросы для интерпретации значения частоты передачи
#define F_CANBR_isUser(br)  (((br) >> 16) != 0)
#define F_CANBR_getUserBtr0(br)  ((u8)((br) >> 24))
#define F_CANBR_getUserBtr1(br)  ((u8)((br) >> 16))

// Таблица: частота - предопределенная константа - значения регистров { BTR0, BTR1 }
// для стандартных частот:
//==================================================
// Bitrate      Predefined constants  { btr0, btr1 }
//==================================================
// 1 MBit/sec   CANBR_1MBaud          { 0x00, 0x14 }
// 800 kBit/sec CANBR_800kBaud        { 0x00, 0x16 }
// 500 kBit/sec CANBR_500kBaud        { 0x00, 0x1c }
// 250 kBit/sec CANBR_250kBaud        { 0x01, 0x1c }
// 125 kBit/sec CANBR_125kBaud        { 0x03, 0x1c }
// 100 kBit/sec CANBR_100kBaud        { 0x04, 0x1c }
// 50 kBit/sec  CANBR_50kBaud         { 0x09, 0x1c }
// 20 kBit/sec  CANBR_20kBaud         { 0x18, 0x1c }
// 10 kBit/sec  CANBR_10kBaud         { 0x31, 0x1c }
//==================================================

// Примеры для конфигурирования на нестандартные частоты
//  40kBd  { 0x87, 0xFF }
//  80kBd  { 0x83, 0xFF }
// 200kBd  { 0x81, 0xFA }
// 400kBd  { 0x80, 0xFA }
